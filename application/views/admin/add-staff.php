              ...
              <div class="box-body">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="txtcity" class="form-control" placeholder="Constituency">
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label>Ward</label>
                    <input type="text" name="txtstate" class="form-control" placeholder="Ward">
                  </div>
                </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" name="slccountry">
                      ...
                      <?php
                        if(isset($county))
                        {
                          foreach ($county as $cnt1)
                          {
                            print "<option value='".$cnt1['county_name']."'>".$cnt1['county_name']."</option>";
                          }
                        }
                      ?>
                    </select>
