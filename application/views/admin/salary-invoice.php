    ...
    <section class="invoice" id="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          From
          <address>
            <strong>Al-fred corp</strong><br>
            Nairobi<br>
            6964 Tom Mboya Street<br>
            Website: www.Al-fred.com<br>
            Email: info@Al-fred.com
          </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          ...
          <address>
            ...
            <?php echo $cnt['state']; ?>, <?php echo $cnt['county']; ?><br>
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td>Ksh. <?php echo $cnt['basic_salary']; ?></td>
                <td>Ksh. <?php echo $cnt['allowance']; ?></td>
                <td>Ksh. <?php echo $cnt['total']; ?></td>
              </tr>
            </tbody>
          </table>
        </div>
